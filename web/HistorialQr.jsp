<%-- 
    ...
    Created on : 03-dic-2016, 20:08:00
    Author     : Sistemas
--%>

<%@page import="serviciosweb.CodeQR"%>
<%@page import="java.util.List"%>
<%@page import="Datos.HisCodQR"%>
...
<html>
    ...
    <body style="background-image: url(img/fnd.jpg) ; background-size: 100vw 100vh;  background-attachment: fixed;">
        <header>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul  class="dropdown-menu"> 
                                    ...
                                    <li><%if (iconoa == 1) {
                                            out.print("<a href='HistorialQr.jsp?cerrar=true'>Cerrar Sesion</a>");
                                        }%></li>
                                </ul>
        ...
        <%
            ...
            if (VariableSession.getAttribute("Idimagen") != null) {
                ...
                VariableSession.setAttribute("consult", ida);
            }
        ...
        <Div style="margin-top:110px;    padding-top: 0px;">
            <h1 style="color: black; margin-left:40px;"> History of your QR codes !!!!</h1>
            <div id="DIVQR" >
                <%                    HisCodQR HC = new HisCodQR();
                    int id = Integer.valueOf(VariableSession.getAttribute("consult").toString());
                    List<CodeQR> cdQR = (List<CodeQR>) HC.QRADDLIST(id);
                    VariableSession.setAttribute("Retorno", cdQR);
                    if (VariableSession.getAttribute("validaUsuario") != null) {

                        for (int i = 0; i < cdQR.size(); i++) {
                            out.println("<div style='margin-top: 40px; margin-left:40px; margin-right:40px; background-color:  rgba(255,255,255,0.6); ' >");
                            out.print("<a style='font-size: 29px;  color: black;' href='HistorialQr.jsp?dode=" + cdQR.get(i).getCodigo() + "'><img  class='img-thumbnail'; src='./HistorialQR?qrText=" + cdQR.get(i).getCodigo() + "'>Select the QR code you want to see the details !!!</a>");
                            out.println("</div>");
                        }
                ...
                <%
                    String Param = request.getParameter("dode");
                    if( Param != null){
                      VariableSession.setAttribute("Url", Param);
                      response.sendRedirect("DetalleQR.jsp");
                   }                              
                %>
